import GKFN_recursive_p as GKFN_recursive
import ft
import pickle
...
if(ON_TRAIN):
    ...
    Yest, num_kernels, kernelMeans, kernelSigma, kernelWeights, epoch =\
        GKFN_recursive.train(data, trX, trY, teX, teY, te_index,
                EPOCHS, m,
...
GKFN_recursive.plot_prediction(teY, teYdate, Yest, num_kernels, epoch, formatter, locater)